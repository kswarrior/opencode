...
"  <form hx-get='/login' hx-target='#msg' hx-swap='innerHTML' hx-include=\"closest form\" style='margin-top:4px'>"
...
"  <form hx-get='/register' hx-target='#msg' hx-swap='innerHTML' hx-include=\"closest form\" style='margin-top:4px'>"
"    <label>Username</label><input name='username' autocomplete='username' required>"
